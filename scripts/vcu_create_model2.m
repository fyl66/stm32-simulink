...
%   Stateflow 3-state (Start/Drive/Brake) ; PWM buzzer ; UART debug ; heartbeat.
    ...
    add_block(mf,[m '/unpack_rx'],'Position',[200 360 300 420]);
    ...
    setEmScript(m,'/pack_st', [ ...
        ...
        "end" newline ...
        "end"]);
    setEmScript(m,'/unpack_rx', [ ...
        "function [vx, yaw] = vcu_unpack_rx(d)" newline ...
        "%#codegen" newline ...
        "vx  = int16(bitshift(uint16(d(1)),8) + uint16(d(2)));" newline ...
        "yaw = int16(bitshift(uint16(d(3)),8) + uint16(d(4)));" newline ...
        "end"]);
    ...
    add_line(m,'CAN_RX_0x200/1','unpack_rx/1');    % Data
    add_line(m,'unpack_rx/1','ctrl_fp/2');         % vx_meas
    ...
    add_line(m,'unpack_rx/1','pack_dbg/2');        % vx
